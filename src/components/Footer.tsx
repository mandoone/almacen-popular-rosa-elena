      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 mb-10 text-center md:text-left">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href={`mailto:${CONTACTO_EMAIL}`} className="hover:text-primary-light transition-colors text-sm break-all">
              {CONTACTO_EMAIL}
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 mb-10">
          ...
          >
            ...
            <span>+{CONTACTO_WHATSAPP_NUMERO}</span>
          </a>
          ...
          >
            ...
            <span>@{CONTACTO_INSTAGRAM_USUARIO}</span>
          </a>
        </div>
