      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 mb-10 text-center md:text-left">
          <div className="flex items-center gap-2">
            ...
            <span>Gamero 2670, Independencia</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:almacenpopular.rosaelenamorarles@gmail.com" className="hover:text-primary-light transition-colors text-sm break-all">
              almacenpopular.rosaelenamorarles@gmail.com
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 mb-10">
          ...
          >
            ...
            <span>@almacenpopular.rosamoralesm</span>
          </a>
        </div>
